...
This sample application requires the Telemetry MQTT sample application setup steps, as it reuses that IoT Thing and certificate. It shows how to create and interact with an IoT Core Named Shadow. The example node within subscribes to shadow changes and publishes them on a ROS topic, as well as exposing service calls for other ROS nodes to update the shadow.
...
To set up this application, you first need to create a named shadow for the Thing. This can be done as follows:
...
To view the named shadow changing, navigate to the IoT Core page of the AWS console, as shown below:
![IoT search bar](images/iot_core_console.png)
